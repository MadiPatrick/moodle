...
/**
 * Strings for component 'block_advnotifications', language 'fr', version '3.10'.
 *
...
$string['privacy:metadata:advnotifications'] = 'Informations sur les notifications auxquelles l\'utilisateur a été exposé et les interactions enregistrées.';
$string['privacy:metadata:advnotifications:blockid'] = 'L\'ID du bloc à partir duquel la notification a été créée (le cas échéant).';
$string['privacy:metadata:advnotifications:created_by'] = 'L\'ID de l\'utilisateur qui a créé les notifications (le cas échéant).';
$string['privacy:metadata:advnotifications:deleted'] = 'Si la notification a été supprimée du site (1 = supprimé).';
$string['privacy:metadata:advnotifications:deleted_by'] = 'L\'ID de l\'utilisateur qui a supprimé la notification (le cas échéant).';
$string['privacy:metadata:advnotifications:message'] = 'Le corps / message de la notification.';
$string['privacy:metadata:advnotifications:title'] = 'Le titre de la notification.';
$string['privacy:metadata:advnotificationsdissed'] = 'Informations sur la relation utilisateur (en tant que consommateur) / notification.';
$string['privacy:metadata:advnotificationsdissed:dismissed'] = 'Indicateur indiquant si la notification a été rejetée par l\'utilisateur ou non (1 = rejetée).';
$string['privacy:metadata:advnotificationsdissed:not_id'] = 'L\'ID de notification associé.';
$string['privacy:metadata:advnotificationsdissed:seen'] = 'Un décompte du nombre de fois où l\'utilisateur a vu / reçu la notification.';
$string['privacy:metadata:advnotificationsdissed:user_id'] = 'L\'ID de l\'utilisateur qui a vu / ignoré la notification.';
