...
/**
 * Strings for component 'availability_completion', language 'fr', version '3.10'.
 *
...
$string['requires_previous_complete'] = 'L\'<strong>activité antérieure avec achèvement</strong> est marquée comme terminée.';
$string['requires_previous_complete_fail'] = 'L\'<strong>activité antérieure avec achèvement</strong> est terminée et échouée';
$string['requires_previous_complete_pass'] = 'L\'<strong>activité antérieure avec achèvement</strong> est terminée et réussie';
$string['requires_previous_incomplete'] = 'L\'<strong>activité antérieure avec achèvement</strong> n\'est pas terminée';
$string['requires_previous_not_complete_fail'] = 'L\'<strong>activité antérieure avec achèvement</strong> n\'est pas terminée et échouée';
$string['requires_previous_not_complete_pass'] = 'L\'<strong>activité antérieure avec achèvement</strong> n\'est pas terminée et réuissie';
