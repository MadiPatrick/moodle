...
/**
 * Strings for component 'tool_oauth2', language 'fr', version '3.10'.
 *
 * @package     tool_oauth2
 * @category    string
...
$string['usebasicauth_help'] = 'Utiliser le schéma d\'authentification HTTP Basic lors de l\'envoi de l\'ID client et du mot de passe lors des requêtes de renouvellement de jeton. Ce réglage est recommandé par le standard OAuth 2, mais n\'est pas disponible avec certains fournisseurs.';
