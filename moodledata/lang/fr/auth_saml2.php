...
/**
 * Strings for component 'auth_saml2', language 'fr', version '3.10'.
 *
 * @package     auth_saml2
 * @category    string
...
$string['mcrypt'] = 'Bibliothèque mcrypt';
$string['mcryptnotfound'] = 'Erreur : la bibliothèque PHP mcrypt est requise, mais n\'est pas installée. Veuillez vous référer à la documentation d\'installation :<br>
