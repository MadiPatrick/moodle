...
/**
 * Strings for component 'payment', language 'fr', version '3.10'.
 *
 * @package     payment
 * @category    string
...
$string['accountdeleteconfirm'] = 'Ce ce compte a des paiements antérieurs, il sera archivé, sinon ses données de configuration seront supprimées de manière permanente. Voulez-vous vraiment continuer ?';
