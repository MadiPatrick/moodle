...
/**
 * Strings for component 'assignfeedback_cloudpoodll', language 'fr', version '3.10'.
 *
...
$string['apisecret_details'] = 'Le secret de l\'API Poodll. Voit <a href= "https://support.poodll.com/support/solutions/articles/19000083076-cloud-poodll-api-secret">ici</a> pour plus de détails';
...
$string['no'] = 'non';
$string['noapisecret'] = 'Aucun secret d\'API saisi. Ce plugin ne fonctionnera pas correctement';
$string['noapiuser'] = 'Aucun utilisateur d\'API saisi. Ce plugin ne fonctionnera pas correctement';
$string['nocredentials'] = 'L\'utilisateur et le secret de l\'API n\'ont pas été entrés. Merci de les saisir sur <a href="{$a}">la page des paramètres.</a> Vous pouvez les obtenir auprès de <a href="https://poodll.com/member">Poodll.com.</a>';
...
$string['novalidcredentials'] = 'L\'utilisateur et le secret de l\'API ont été rejetés et n\'ont pas pu fournir d\'accès. Merci de les vérifer sur <a href="{$a}">la page des paramètres.</a> Vous pouvez les obtenir auprès de <a href="https://poodll.com/member">Poodll.com.</a>';
