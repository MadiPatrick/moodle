...
/**
 * Strings for component 'organizer', language 'fr', version '3.10'.
 *
 * @package     organizer
 * @category    string
...
$string['appointment_reminder:student:fullmessage'] = 'Bonjour {$a->receivername},
...
$string['appointment_reminder:student:group:fullmessage'] = 'Bonjour {$a->receivername},
...
Système de messagerie Moodle';
$string['appointment_reminder:student:group:smallmessage'] = 'Vous avez un rendez-vous de groupe avec {$a->sendername} le {$a->date} à {$a->time} dans le local {$a->location}.';
$string['appointment_reminder:student:group:subject'] = '[{$a->courseid}{$a->courseshortname} / {$a->organizername}] - Rappel de rendez-vous de groupe';
$string['appointment_reminder:student:smallmessage'] = 'Vous avez un rendez-vous avec {$a->sendername} le {$a->date} à {$a->time} dans le local {$a->location}.';
$string['appointment_reminder:student:subject'] = '[{$a->courseid}{$a->courseshortname} / {$a->organizername}] - Rappel de rendez-vous';
$string['appointment_reminder:teacher:digest:fullmessage'] = 'Bonjour {$a->receivername},
...
Système de messagerie Moodle';
$string['appointment_reminder:teacher:digest:smallmessage'] = 'Vous avez reçu un message avec le résumé de votre rendez-vous de demain.';
$string['appointment_reminder:teacher:digest:subject'] = 'Résumé du rendez-vous';
$string['appointment_reminder:teacher:fullmessage'] = 'Bonjour {$a->receivername},
...
Système de messagerie Moodle';
$string['appointment_reminder:teacher:group:digest:fullmessage'] = 'Bonjour {$a->receivername},
...
Système de messagerie Moodle';
$string['appointment_reminder:teacher:group:digest:smallmessage'] = 'Vous avez reçu un message avec le résumé de vos rendez-vous de demain.';
$string['appointment_reminder:teacher:group:digest:subject'] = 'Résumé des rendez-vous';
$string['appointment_reminder:teacher:smallmessage'] = 'Vous avez un rendez-vous avec des étudiants le {$a->date} à {$a->time} dans le local {$a->location}.';
$string['appointment_reminder:teacher:subject'] = '[{$a->courseid}{$a->courseshortname} / {$a->organizername}] - Rappel de rendez-vous';
...
$string['assign_notify:student:fullmessage'] = 'Bonjour {$a->receivername},
...
Système de messagerie Moodle';
$string['assign_notify:student:group:fullmessage'] = 'Bonjour {$a->receivername},
...
Système de messagerie Moodle';
$string['assign_notify:student:group:smallmessage'] = '{$a->sendername} a fixé un rendez-vous à votre groupe {$a->groupname} avec {$a->slot_teacher} le {$a->date} à {$a->time}.';
$string['assign_notify:student:group:subject'] = '[{$a->courseid}{$a->courseshortname} / {$a->organizername}] - Rendez-vous fixé par l\'enseignant';
$string['assign_notify:student:smallmessage'] = '{$a->sendername} vous a fixé un rendez-vous avec {$a->slot_teacher} le {$a->date} à {$a->time}.';
$string['assign_notify:student:subject'] = '[{$a->courseid}{$a->courseshortname} / {$a->organizername}] - Rendez-vous fixé par l\'enseignant';
$string['assign_notify:teacher:fullmessage'] = 'Bonjour {$a->receivername},
...
Système de messagerie Moodle';
$string['assign_notify:teacher:group:fullmessage'] = 'Bonjour {$a->receivername},
...
Système de messagerie Moodle';
$string['assign_notify:teacher:group:smallmessage'] = '{$a->sendername} vous a fixé un rendez-vous avec le groupe {$a->groupname} le {$a->date} à {$a->time}.';
$string['assign_notify:teacher:group:subject'] = '[{$a->courseid}{$a->courseshortname} / {$a->organizername}] - Rendez-vous fixé';
$string['assign_notify:teacher:smallmessage'] = '{$a->sendername} vous a fixé un rendez-vous avec lui/elle le {$a->date} à {$a->time}.';
$string['assign_notify:teacher:subject'] = '[{$a->courseid}{$a->courseshortname} / {$a->organizername}] - Rendez-vous fixé';
...
$string['edit_notify:student:fullmessage'] = 'Bonjour {$a->receivername},

Dans le cadre du cours {$a->courseid} {$a->coursefullname}, votre rendez-vous avec {$a->sendername} du {$a->date} à {$a->time} a été modifié.
...
Système de messagerie Moodle';
$string['edit_notify:student:group:fullmessage'] = 'Bonjour {$a->receivername},

Dans le cadre du cours {$a->courseid} {$a->coursefullname}, votre rendez-vous de groupe avec {$a->sendername} du {$a->date} à {$a->time} a été modifié.
...
Système de messagerie Moodle';
$string['edit_notify:student:group:smallmessage'] = 'Le rendez-vous de groupe avec {$a->sendername} le {$a->date} à {$a->time} a été modifié.';
$string['edit_notify:student:group:subject'] = '[{$a->courseid}{$a->courseshortname} / {$a->organizername}] - Rendez-vous modifié';
$string['edit_notify:student:smallmessage'] = 'Le redez-vous avec {$a->sendername} le {$a->date} à {$a->time} a été modifié.';
$string['edit_notify:student:subject'] = '[{$a->courseid}{$a->courseshortname} / {$a->organizername}] - Rendez-vous modifié';
$string['edit_notify:teacher:fullmessage'] = 'Bonjour {$a->receivername},
...
Système de messagerie Moodle';
$string['edit_notify:teacher:group:fullmessage'] = 'Bonjour {$a->receivername},
...
Système de messagerie Moodle';
$string['edit_notify:teacher:group:smallmessage'] = '{$a->sendername} a modifié le créneau du {$a->date} à {$a->time}.';
$string['edit_notify:teacher:group:subject'] = '[{$a->courseid}{$a->courseshortname} / {$a->organizername}] - Rendez-vous modifié';
$string['edit_notify:teacher:smallmessage'] = '{$a->sendername} a modifié le créneau du {$a->date} à {$a->time}.';
$string['edit_notify:teacher:subject'] = '[{$a->courseid}{$a->courseshortname} / {$a->organizername}] - Rendez-vous modifié';
...
$string['eval_notify:student:fullmessage'] = 'Bonjour {$a->receivername},
...
Système de messagerie Moodle';
$string['eval_notify:student:group:fullmessage'] = 'Bonjour {$a->receivername},
...
Système de messagerie Moodle';
$string['eval_notify:student:group:smallmessage'] = 'Votre rendez-vous de groupe du {$a->date} à {$a->time} dans le local {$a->location} a été évalué.';
$string['eval_notify:student:group:subject'] = '[{$a->courseid}{$a->courseshortname} / {$a->organizername}] - Rendez-vous évalué';
$string['eval_notify:student:smallmessage'] = 'Votre rendez-vous du {$a->date} à {$a->time} dans le local {$a->location} a été évalué.';
$string['eval_notify:student:subject'] = '[{$a->courseid}{$a->courseshortname} / {$a->organizername}] - Rendez-vous évalué';
...
$string['messageprovider:appointment_reminder:student'] = 'Rappel de rendez-vous de l\'agenda';
$string['messageprovider:appointment_reminder:teacher'] = 'Rappel de rendez-vous de l\'agenda (enseignant)';
$string['messageprovider:assign_notify:student'] = 'Attribution de l\'agenda par l\'enseignant';
$string['messageprovider:assign_notify:teacher'] = 'Attribution de l\'agenda';
$string['messageprovider:edit_notify:student'] = 'Changements à l\'agenda';
$string['messageprovider:edit_notify:teacher'] = 'Changements à l\'agenda (enseignant)';
$string['messageprovider:eval_notify:student'] = 'Notification de l\'évaluation de l\'agenda';
$string['messageprovider:group_registration_notify:student'] = 'Notification de l\'inscription de groupe dans l\'agenda';
$string['messageprovider:manual_reminder:student'] = 'Rappel manuel de rendez-vous de l\'agenda';
$string['messageprovider:register_notify:teacher'] = 'Notification d\'inscription dans l\'agenda';
$string['messageprovider:register_reminder:student'] = 'Rappel d\'inscription dans l\'agenda';
$string['messageprovider:slotdeleted_notify:student'] = 'Créneaux de l’agenda supprimés';
...
$string['register_notify:teacher:queue:fullmessage'] = 'Bonjour {$a->receivername},

Dans le cadre du cours {$a->courseid} {$a->coursefullname}, l\'étudiant-e {$a->sendername} s\'est inscrit-e sur la liste d\'attente pour le créneau du {$a->date} à {$a->time} dans le local {$a->location}.

Système de messagerie Moodle';
$string['register_notify:teacher:queue:group:fullmessage'] = 'Bonjour {$a->receivername},

Dans le cadre du cours {$a->courseid} {$a->coursefullname}, l\'étudiant-e {$a->sendername} a inscrit son groupe {$a->groupname} sur la liste d\'attente pour le créneau du {$a->date} à {$a->time} dans le local {$a->location}.

Système de messagerie Moodle';
$string['register_notify:teacher:queue:group:smallmessage'] = 'L\'étudiant-e {$a->sendername} a inscrit son groupe {$a->groupname} sur la liste d\'attente pour le créneau du {$a->date} à {$a->time} dans le local {$a->location}.';
$string['register_notify:teacher:queue:group:subject'] = '[{$a->courseid}{$a->courseshortname} / {$a->organizername}] - Groupe mis en attente';
$string['register_notify:teacher:queue:smallmessage'] = 'L\'étudiant-e {$a->sendername} s\'est inscrit-e sur la liste d\'attente pour le créneau du {$a->date} à {$a->time} dans le local {$a->location}.';
$string['register_notify:teacher:queue:subject'] = '[{$a->courseid}{$a->courseshortname} / {$a->organizername}] - Étudiant mis en attente';
$string['register_notify:teacher:register:fullmessage'] = 'Bonjour {$a->receivername},

Dans le cadre du cours {$a->courseid} {$a->coursefullname}, l\'étudiant-e {$a->sendername} s\'est inscrit-e pour le créneau du {$a->date} à {$a->time} dans le local {$a->location}.

Système de messagerie Moodle';
$string['register_notify:teacher:register:group:fullmessage'] = 'Bonjour {$a->receivername},

Dans le cadre du cours {$a->courseid} {$a->coursefullname}, l\'étudiant-e {$a->sendername} a inscrit son groupe {$a->groupname} pour le créneau du {$a->date} à {$a->time} dans le local {$a->location}.

Système de messagerie Moodle';
$string['register_notify:teacher:register:group:smallmessage'] = 'L\'étudiant-e {$a->sendername} a inscrit son groupe {$a->groupname} pour le créneau du {$a->date} à {$a->time} dans le local {$a->location}.';
$string['register_notify:teacher:register:group:subject'] = '[{$a->courseid}{$a->courseshortname} / {$a->organizername}] - Groupe inscrit';
$string['register_notify:teacher:register:smallmessage'] = 'L\'étudiant-e {$a->sendername} s\'est inscrit-e pour le créneau du {$a->date} à {$a->time} dans le local {$a->location}.';
$string['register_notify:teacher:register:subject'] = '[{$a->courseid}{$a->courseshortname} / {$a->organizername}] - Étudiant inscrit';
$string['register_notify:teacher:reregister:fullmessage'] = 'Bonjour {$a->receivername},

Dans le cadre du cours {$a->courseid} {$a->coursefullname}, l\'étudiant-e {$a->sendername} s\'est réinscrit-e pour un nouveau créneau, le {$a->date} à {$a->time} dans le local {$a->location}.

Système de messagerie Moodle';
$string['register_notify:teacher:reregister:group:fullmessage'] = 'Bonjour {$a->receivername},

Dans le cadre du cours {$a->courseid} {$a->coursefullname}, l\'étudiant-e {$a->sendername} a réinscrit son groupe {$a->groupname} pour un nouveau créneau, le {$a->date} à {$a->time} dans le local {$a->location}.

Système de messagerie Moodle';
$string['register_notify:teacher:reregister:group:smallmessage'] = 'L\'étudiant-e {$a->sendername} a réinscrit son groupe {$a->groupname} pour un nouveau créneau, le {$a->date} à {$a->time} dans le local {$a->location}.';
$string['register_notify:teacher:reregister:group:subject'] = '[{$a->courseid}{$a->courseshortname} / {$a->organizername}] - Groupe réinscrit';
$string['register_notify:teacher:reregister:smallmessage'] = 'L\'étudiant-e {$a->sendername} s\'est réinscrit-e pour un nouveau créneau, le {$a->date} à {$a->time} dans le local {$a->location}.';
$string['register_notify:teacher:reregister:subject'] = '[{$a->courseid}{$a->courseshortname} / {$a->organizername}] - Étudiant réinscrit';
$string['register_notify:teacher:unqueue:fullmessage'] = 'Bonjour {$a->receivername},

Dans le cadre du cours {$a->courseid} {$a->coursefullname}, l\'étudiant-e {$a->sendername} s\'est retiré-e de la liste d\'attente pour le créneau du {$a->date} à {$a->time} dans le local {$a->location}.

Système de messagerie Moodle';
$string['register_notify:teacher:unqueue:group:fullmessage'] = 'Bonjour {$a->receivername},

Dans le cadre du cours {$a->courseid} {$a->coursefullname}, l\'étudiant-e {$a->sendername} a retiré son groupe {$a->groupname} de la liste d\'attente pour le créneau du {$a->date} à {$a->time} dans le local {$a->location}.

Système de messagerie Moodle';
$string['register_notify:teacher:unqueue:group:smallmessage'] = 'L\'étudiant-e {$a->sendername} a retiré son groupe {$a->groupname} de la liste d\'attente pour le créneau du {$a->date} à {$a->time} dans le local {$a->location}.';
$string['register_notify:teacher:unqueue:group:subject'] = '[{$a->courseid}{$a->courseshortname} / {$a->organizername}] - Groupe retiré de la liste d\'attente';
$string['register_notify:teacher:unqueue:smallmessage'] = 'L\'étudiant-e {$a->sendername} s\'est retiré-e de la liste d\'attente pour le créneau du {$a->date} à {$a->time} dans le local {$a->location}.';
$string['register_notify:teacher:unqueue:subject'] = '[{$a->courseid}{$a->courseshortname} / {$a->organizername}] - Étudiant retiré de la liste d\'attente';
$string['register_notify:teacher:unregister:fullmessage'] = 'Bonjour {$a->receivername},

Dans le cadre du cours {$a->courseid} {$a->coursefullname}, l\'étudiant-e {$a->sendername} s\'est désinscrit-e du créneau du {$a->date} à {$a->time} dans le local {$a->location}.

Système de messagerie Moodle';
$string['register_notify:teacher:unregister:group:fullmessage'] = 'Bonjour {$a->receivername},

Dans le cadre du cours {$a->courseid} {$a->coursefullname}, l\'étudiant-e {$a->sendername} a désinscrit son groupe {$a->groupname} du le créneau du {$a->date} à {$a->time} dans le local {$a->location}.

Système de messagerie Moodle';
$string['register_notify:teacher:unregister:group:smallmessage'] = 'L\'étudiant-e {$a->sendername} a désinscrit son groupe {$a->groupname} du le créneau du {$a->date} à {$a->time} dans le local {$a->location}.';
$string['register_notify:teacher:unregister:group:subject'] = '[{$a->courseid}{$a->courseshortname} / {$a->organizername}] - Groupe désinscrit';
$string['register_notify:teacher:unregister:smallmessage'] = 'L\'étudiant-e {$a->sendername} s\'est désinscrit-e du créneau du {$a->date} à {$a->time} dans le local {$a->location}.';
$string['register_notify:teacher:unregister:subject'] = '[{$a->courseid}{$a->courseshortname} / {$a->organizername}] - Étudiant désinscrit';
$string['register_reminder:group:fullmessage'] = 'Bonjour {$a->receivername},

dans le cadre du cours {$a->courseid} {$a->coursefullname}, votre groupe {$a->groupname} soit ne s\'est encore inscrit à aucun créneau horaire, soit ne s\'est pas présenté à celui auquel il était inscrit.

{$a->custommessage}

Système de messagerie Moodle';
$string['register_reminder:group:smallmessage'] = 'Merci d\'inscrire votre groupe dans un (autre) créneau horaire.';
$string['register_reminder:group:subject'] = '[{$a->courseid}{$a->courseshortname} / {$a->organizername}] - Rappel d\'inscription';
$string['register_reminder:student:fullmessage'] = 'Bonjour {$a->receivername},

dans le cadre du cours {$a->courseid} {$a->coursefullname}, soit vous ne vous êtes encore inscrit-e à aucun créneau horaire, soit vous ne vous êtes pas présenté-e à celui auquel vous étiez inscrit-e.

{$a->custommessage}

Système de messagerie Moodle';
$string['register_reminder:student:group:fullmessage'] = 'Bonjour {$a->receivername},
...
Système de messagerie Moodle';
$string['register_reminder:student:group:smallmessage'] = 'Merci d\'inscrire votre groupe dans un nouveau créneau horaire.';
$string['register_reminder:student:group:subject'] = '[{$a->courseid}{$a->courseshortname} / {$a->organizername}] - Rappel d\'inscription';
$string['register_reminder:student:smallmessage'] = 'Merci de vous inscrire dans un (autre) créneau horaire.';
$string['register_reminder:student:subject'] = '[{$a->courseid}{$a->courseshortname} / {$a->organizername}] - Rappel d\'inscription';
...
$string['slotdeleted_notify:student:fullmessage'] = 'Bonjour {$a->receivername},

Votre rendez-vous dans le cours {$a->courseshortname} le {$a->date} à {$a->time} dans le local {$a->location} a été annulé.
Ceci veut dire que vous n\'avez plus de rendez-vous dans l\'agenda {$a->organizername}.
Veuillez suivre le lien suivant pour vous choisir un nouveau rendez-vous: {$a->courselink}';
$string['slotdeleted_notify:student:group:fullmessage'] = 'Bonjour {$a->receivername},

Votre rendez-vous dans le cours {$a->courseshortname} le {$a->date} à {$a->time} dans le local {$a->location} a été annulé.
Ceci veut dire que vous n\'avez plus de rendez-vous dans l\'agenda {$a->organizername}.
Veuillez suivre le lien suivant pour vous choisir un nouveau rendez-vous: {$a->courselink}';
$string['slotdeleted_notify:student:group:smallmessage'] = 'Votre rendez-vous du {$a->date} à {$a->time} dans l\'agenda "{$a->organizername}" a été annulé.';
$string['slotdeleted_notify:student:group:subject'] = '[{$a->courseid}{$a->courseshortname} / {$a->organizername}] - Rendez-vous annulé';
$string['slotdeleted_notify:student:smallmessage'] = 'Votre rendez-vous du {$a->date} à {$a->time} dans l\'agenda "{$a->organizername}" a été annulé.';
$string['slotdeleted_notify:student:subject'] = '[{$a->courseid}{$a->courseshortname} / {$a->organizername}] - Rendez-vous annulé';
